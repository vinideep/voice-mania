...
class WhisperPrompt: ObservableObject {
    ...
    private let languagePrompts: [String: String] = [
        ...
        "ta": "இந்த file-ஐ download பண்ணு. Settings-ல language option இருக்கு. Let's check the report tomorrow. நாளைக்கு meeting இருக்கு.",
        "auto": "இந்த file-ஐ download பண்ணு. Settings-ல language option இருக்கு. Let's check the report tomorrow. நாளைக்கு meeting இருக்கு.",
